...
public class LatihanModel {
    ...
    public LatihanModel(String latihan, String optionA, String optionB, String optionC, String optionD, int correctAns, int selectedAns, int status) {
